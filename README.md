...
[![Codecov test
coverage](https://codecov.io/gh/cenwu/mixedBayes/branch/master/graph/badge.svg)](https://app.codecov.io/gh/cenwu/mixedBayes?branch=master)
[![CRAN RStudio mirror
downloads](https://cranlogs.r-pkg.org/badges/mixedBayes)](https://www.r-pkg.org:443/pkg/mixedBayes)
[![R-CMD-check](https://github.com/cenwu/mixedBayes/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/cenwu/mixedBayes/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
